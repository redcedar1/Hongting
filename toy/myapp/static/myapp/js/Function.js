...
function create() {
    ...
    if(/*나이값 없으면*/ false) {
        ...
        elem.innerHTML = "<input type=text id=input placeholder=학교 size=10 required></input>\
                <input type=text id=input placeholder=학과 size=10 required></input> "
    }
    else if(/*mbti*/ false) {
        ...
        elem.innerHTML = "<label> <input type=checkbox value=운동 > 운동 </label> \
                <label> <input type=checkbox value=맛집탐방> 맛집탐방 </label>" //이런 관심사들 집어넣기
    }
    else if(/*자유로운 자기소개*/ true) {
