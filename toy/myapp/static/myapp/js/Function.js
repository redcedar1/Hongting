...
function createStr(count) {
    ...
    else if(count==3) document.write("직업"); //대학생, 대학원생, 취준생, 직장인
    else if(count==4) document.write("학교와 학과"); //학교 인증 시스템 넣기
    else if(count==5) document.write("mbti");
    else if(count==6) document.write("군/미필");
    else if(count==7) document.write("키"); //범위로(5단위)
    else if(count==8) document.write("체형"); //탭으로(마름, 보통, 통통, 근육)
    else if(count==9) document.write("유/무쌍"); //탭으로
    else if(count==10) document.write("얼굴상"); //뚜렷, 두부
    else if(count==11) document.write("관심사"); //탭으로
    else if(count==12) {
...
function create(count) {
    ...
    if(count==1) {
        ...
        elem.innerHTML = "<input type=radio id=1 name=army value=군필 > <label for=1> 군필 </label> \
                <input type=radio id=2 name=army value=미필> <label for=2> 미필 </label>"
    }
    else if(count==7) {
